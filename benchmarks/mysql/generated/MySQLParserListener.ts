// Generated from /Volumes/Extern/Work/projects/antlr4wasm/benchmarks/mysql/MySQLParser.g4 by ANTLR 4.9.0-SNAPSHOT
...
import { QueryExpressionBodyNewContext } from "./MySQLParser";
...
export interface MySQLParserListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by `MySQLParser.queryExpressionBodyNew`.
	 * @param ctx the parse tree
	 */
	enterQueryExpressionBodyNew?: (ctx: QueryExpressionBodyNewContext) => void;
	/**
	 * Exit a parse tree produced by `MySQLParser.queryExpressionBodyNew`.
	 * @param ctx the parse tree
	 */
	exitQueryExpressionBodyNew?: (ctx: QueryExpressionBodyNewContext) => void;
