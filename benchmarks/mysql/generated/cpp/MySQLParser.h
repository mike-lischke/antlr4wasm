...
public:
  ...
  enum {
    ...
    RuleQueryExpression = 140, RuleQueryExpressionBody = 141, RuleQueryExpressionParens = 142, 
    RuleQueryPrimary = 143, RuleQuerySpecification = 144, RuleSubquery = 145, 
    RuleQuerySpecOption = 146, RuleLimitClause = 147, RuleSimpleLimitClause = 148, 
    RuleLimitOptions = 149, RuleLimitOption = 150, RuleIntoClause = 151, 
    RuleProcedureAnalyseClause = 152, RuleHavingClause = 153, RuleWindowClause = 154, 
    RuleWindowDefinition = 155, RuleWindowSpec = 156, RuleWindowSpecDetails = 157, 
    RuleWindowFrameClause = 158, RuleWindowFrameUnits = 159, RuleWindowFrameExtent = 160, 
    RuleWindowFrameStart = 161, RuleWindowFrameBetween = 162, RuleWindowFrameBound = 163, 
    RuleWindowFrameExclusion = 164, RuleWithClause = 165, RuleCommonTableExpression = 166, 
    RuleGroupByClause = 167, RuleOlapOption = 168, RuleOrderClause = 169, 
    RuleDirection = 170, RuleFromClause = 171, RuleTableReferenceList = 172, 
    RuleTableValueConstructor = 173, RuleExplicitTable = 174, RuleRowValueExplicit = 175, 
    RuleSelectOption = 176, RuleLockingClauseList = 177, RuleLockingClause = 178, 
    RuleLockStrengh = 179, RuleLockedRowAction = 180, RuleSelectItemList = 181, 
    RuleSelectItem = 182, RuleSelectAlias = 183, RuleWhereClause = 184, 
    RuleTableReference = 185, RuleEscapedTableReference = 186, RuleJoinedTable = 187, 
    RuleNaturalJoinType = 188, RuleInnerJoinType = 189, RuleOuterJoinType = 190, 
    RuleTableFactor = 191, RuleSingleTable = 192, RuleSingleTableParens = 193, 
    RuleDerivedTable = 194, RuleTableReferenceListParens = 195, RuleTableFunction = 196, 
    RuleColumnsClause = 197, RuleJtColumn = 198, RuleOnEmptyOrError = 199, 
    RuleOnEmptyOrErrorJsonTable = 200, RuleOnEmpty = 201, RuleOnError = 202, 
    RuleJsonOnResponse = 203, RuleUnionOption = 204, RuleTableAlias = 205, 
    RuleIndexHintList = 206, RuleIndexHint = 207, RuleIndexHintType = 208, 
    RuleKeyOrIndex = 209, RuleConstraintKeyType = 210, RuleIndexHintClause = 211, 
    RuleIndexList = 212, RuleIndexListElement = 213, RuleUpdateStatement = 214, 
    RuleTransactionOrLockingStatement = 215, RuleTransactionStatement = 216, 
    RuleBeginWork = 217, RuleStartTransactionOptionList = 218, RuleSavepointStatement = 219, 
    RuleLockStatement = 220, RuleLockItem = 221, RuleLockOption = 222, RuleXaStatement = 223, 
    RuleXaConvert = 224, RuleXid = 225, RuleReplicationStatement = 226, 
    RuleResetOption = 227, RuleSourceResetOptions = 228, RuleReplicationLoad = 229, 
    RuleChangeReplicationSource = 230, RuleChangeSource = 231, RuleSourceDefinitions = 232, 
    RuleSourceDefinition = 233, RuleChangeReplicationSourceAutoPosition = 234, 
    RuleChangeReplicationSourceHost = 235, RuleChangeReplicationSourceBind = 236, 
    RuleChangeReplicationSourceUser = 237, RuleChangeReplicationSourcePassword = 238, 
    RuleChangeReplicationSourcePort = 239, RuleChangeReplicationSourceConnectRetry = 240, 
    RuleChangeReplicationSourceRetryCount = 241, RuleChangeReplicationSourceDelay = 242, 
    RuleChangeReplicationSourceSSL = 243, RuleChangeReplicationSourceSSLCA = 244, 
    RuleChangeReplicationSourceSSLCApath = 245, RuleChangeReplicationSourceSSLCipher = 246, 
    RuleChangeReplicationSourceSSLCLR = 247, RuleChangeReplicationSourceSSLCLRpath = 248, 
    RuleChangeReplicationSourceSSLKey = 249, RuleChangeReplicationSourceSSLVerifyServerCert = 250, 
    RuleChangeReplicationSourceTLSVersion = 251, RuleChangeReplicationSourceTLSCiphersuites = 252, 
    RuleChangeReplicationSourceSSLCert = 253, RuleChangeReplicationSourcePublicKey = 254, 
    RuleChangeReplicationSourceGetSourcePublicKey = 255, RuleChangeReplicationSourceHeartbeatPeriod = 256, 
    RuleChangeReplicationSourceCompressionAlgorithm = 257, RuleChangeReplicationSourceZstdCompressionLevel = 258, 
    RulePrivilegeCheckDef = 259, RuleTablePrimaryKeyCheckDef = 260, RuleAssignGtidsToAnonymousTransactionsDefinition = 261, 
    RuleSourceTlsCiphersuitesDef = 262, RuleSourceFileDef = 263, RuleSourceLogFile = 264, 
    RuleSourceLogPos = 265, RuleServerIdList = 266, RuleChangeReplication = 267, 
    RuleFilterDefinition = 268, RuleFilterDbList = 269, RuleFilterTableList = 270, 
    RuleFilterStringList = 271, RuleFilterWildDbTableString = 272, RuleFilterDbPairList = 273, 
    RuleStartReplicaStatement = 274, RuleStopReplicaStatement = 275, RuleReplicaUntil = 276, 
    RuleUserOption = 277, RulePasswordOption = 278, RuleDefaultAuthOption = 279, 
    RulePluginDirOption = 280, RuleReplicaThreadOptions = 281, RuleReplicaThreadOption = 282, 
    RuleGroupReplication = 283, RuleGroupReplicationStartOptions = 284, 
    RuleGroupReplicationStartOption = 285, RuleGroupReplicationUser = 286, 
    RuleGroupReplicationPassword = 287, RuleGroupReplicationPluginAuth = 288, 
    RuleReplica = 289, RulePreparedStatement = 290, RuleExecuteStatement = 291, 
    RuleExecuteVarList = 292, RuleCloneStatement = 293, RuleDataDirSSL = 294, 
    RuleSsl = 295, RuleAccountManagementStatement = 296, RuleAlterUserStatement = 297, 
    RuleAlterUserList = 298, RuleAlterUser = 299, RuleOldAlterUser = 300, 
    RuleUserFunction = 301, RuleCreateUserStatement = 302, RuleCreateUserTail = 303, 
    RuleUserAttributes = 304, RuleDefaultRoleClause = 305, RuleRequireClause = 306, 
    RuleConnectOptions = 307, RuleAccountLockPasswordExpireOptions = 308, 
    RuleUserAttribute = 309, RuleDropUserStatement = 310, RuleGrantStatement = 311, 
    RuleGrantTargetList = 312, RuleGrantOptions = 313, RuleExceptRoleList = 314, 
    RuleWithRoles = 315, RuleGrantAs = 316, RuleVersionedRequireClause = 317, 
    RuleRenameUserStatement = 318, RuleRevokeStatement = 319, RuleAclType = 320, 
    RuleRoleOrPrivilegesList = 321, RuleRoleOrPrivilege = 322, RuleGrantIdentifier = 323, 
    RuleRequireList = 324, RuleRequireListElement = 325, RuleGrantOption = 326, 
    RuleSetRoleStatement = 327, RuleRoleList = 328, RuleRole = 329, RuleTableAdministrationStatement = 330, 
    RuleHistogram = 331, RuleCheckOption = 332, RuleRepairType = 333, RuleInstallUninstallStatement = 334, 
    RuleSetStatement = 335, RuleStartOptionValueList = 336, RuleTransactionCharacteristics = 337, 
    RuleTransactionAccessMode = 338, RuleIsolationLevel = 339, RuleOptionValueListContinued = 340, 
    RuleOptionValueNoOptionType = 341, RuleOptionValue = 342, RuleSetSystemVariable = 343, 
    RuleStartOptionValueListFollowingOptionType = 344, RuleOptionValueFollowingOptionType = 345, 
    RuleSetExprOrDefault = 346, RuleShowDatabasesStatement = 347, RuleShowTablesStatement = 348, 
    RuleShowTriggersStatement = 349, RuleShowEventsStatement = 350, RuleShowTableStatusStatement = 351, 
    RuleShowOpenTablesStatement = 352, RuleShowPluginsStatement = 353, RuleShowEngineLogsStatement = 354, 
    RuleShowEngineMutexStatement = 355, RuleShowEngineStatusStatement = 356, 
    RuleShowColumnsStatement = 357, RuleShowBinaryLogsStatement = 358, RuleShowReplicasStatement = 359, 
    RuleShowBinlogEventsStatement = 360, RuleShowRelaylogEventsStatement = 361, 
    RuleShowKeysStatement = 362, RuleShowEnginesStatement = 363, RuleShowCountWarningsStatement = 364, 
    RuleShowCountErrorsStatement = 365, RuleShowWarningsStatement = 366, 
    RuleShowErrorsStatement = 367, RuleShowProfilesStatement = 368, RuleShowProfileStatement = 369, 
    RuleShowStatusStatement = 370, RuleShowProcessListStatement = 371, RuleShowVariablesStatement = 372, 
    RuleShowCharacterSetStatement = 373, RuleShowCollationStatement = 374, 
    RuleShowPrivilegesStatement = 375, RuleShowGrantsStatement = 376, RuleShowCreateDatabaseStatement = 377, 
    RuleShowCreateTableStatement = 378, RuleShowCreateViewStatement = 379, 
    RuleShowMasterStatusStatement = 380, RuleShowReplicaStatusStatement = 381, 
    RuleShowCreateProcedureStatement = 382, RuleShowCreateFunctionStatement = 383, 
    RuleShowCreateTriggerStatement = 384, RuleShowCreateProcedureStatusStatement = 385, 
    RuleShowCreateFunctionStatusStatement = 386, RuleShowCreateProcedureCodeStatement = 387, 
    RuleShowCreateFunctionCodeStatement = 388, RuleShowCreateEventStatement = 389, 
    RuleShowCreateUserStatement = 390, RuleShowCommandType = 391, RuleEngineOrAll = 392, 
    RuleFromOrIn = 393, RuleInDb = 394, RuleProfileDefinitions = 395, RuleProfileDefinition = 396, 
    RuleOtherAdministrativeStatement = 397, RuleKeyCacheListOrParts = 398, 
    RuleKeyCacheList = 399, RuleAssignToKeycache = 400, RuleAssignToKeycachePartition = 401, 
    RuleCacheKeyList = 402, RuleKeyUsageElement = 403, RuleKeyUsageList = 404, 
    RuleFlushOption = 405, RuleLogType = 406, RuleFlushTables = 407, RuleFlushTablesOptions = 408, 
    RulePreloadTail = 409, RulePreloadList = 410, RulePreloadKeys = 411, 
    RuleAdminPartition = 412, RuleResourceGroupManagement = 413, RuleCreateResourceGroup = 414, 
    RuleResourceGroupVcpuList = 415, RuleVcpuNumOrRange = 416, RuleResourceGroupPriority = 417, 
    RuleResourceGroupEnableDisable = 418, RuleAlterResourceGroup = 419, 
    RuleSetResourceGroup = 420, RuleThreadIdList = 421, RuleDropResourceGroup = 422, 
    RuleUtilityStatement = 423, RuleDescribeStatement = 424, RuleExplainStatement = 425, 
    RuleExplainableStatement = 426, RuleHelpCommand = 427, RuleUseCommand = 428, 
    RuleRestartServer = 429, RuleExpr = 430, RuleBoolPri = 431, RuleCompOp = 432, 
    RulePredicate = 433, RulePredicateOperations = 434, RuleBitExpr = 435, 
    RuleSimpleExpr = 436, RuleArrayCast = 437, RuleJsonOperator = 438, RuleSumExpr = 439, 
    RuleGroupingOperation = 440, RuleWindowFunctionCall = 441, RuleWindowingClause = 442, 
    RuleLeadLagInfo = 443, RuleStableInteger = 444, RuleParamOrVar = 445, 
    RuleNullTreatment = 446, RuleJsonFunction = 447, RuleInSumExpr = 448, 
    RuleIdentListArg = 449, RuleIdentList = 450, RuleFulltextOptions = 451, 
    RuleRuntimeFunctionCall = 452, RuleReturningType = 453, RuleGeometryFunction = 454, 
    RuleTimeFunctionParameters = 455, RuleFractionalPrecision = 456, RuleWeightStringLevels = 457, 
    RuleWeightStringLevelListItem = 458, RuleDateTimeTtype = 459, RuleTrimFunction = 460, 
    RuleSubstringFunction = 461, RuleFunctionCall = 462, RuleUdfExprList = 463, 
    RuleUdfExpr = 464, RuleUserVariable = 465, RuleInExpressionUserVariableAssignment = 466, 
    RuleRvalueSystemOrUserVariable = 467, RuleLvalueVariable = 468, RuleRvalueSystemVariable = 469, 
    RuleWhenExpression = 470, RuleThenExpression = 471, RuleElseExpression = 472, 
    RuleCastType = 473, RuleExprList = 474, RuleCharset = 475, RuleNotRule = 476, 
    RuleNot2Rule = 477, RuleInterval = 478, RuleIntervalTimeStamp = 479, 
    RuleExprListWithParentheses = 480, RuleExprWithParentheses = 481, RuleSimpleExprWithParentheses = 482, 
    RuleOrderList = 483, RuleOrderExpression = 484, RuleGroupList = 485, 
    RuleGroupingExpression = 486, RuleChannel = 487, RuleCompoundStatement = 488, 
    RuleReturnStatement = 489, RuleIfStatement = 490, RuleIfBody = 491, 
    RuleThenStatement = 492, RuleCompoundStatementList = 493, RuleCaseStatement = 494, 
    RuleElseStatement = 495, RuleLabeledBlock = 496, RuleUnlabeledBlock = 497, 
    RuleLabel = 498, RuleBeginEndBlock = 499, RuleLabeledControl = 500, 
    RuleUnlabeledControl = 501, RuleLoopBlock = 502, RuleWhileDoBlock = 503, 
    RuleRepeatUntilBlock = 504, RuleSpDeclarations = 505, RuleSpDeclaration = 506, 
    RuleVariableDeclaration = 507, RuleConditionDeclaration = 508, RuleSpCondition = 509, 
    RuleSqlstate = 510, RuleHandlerDeclaration = 511, RuleHandlerCondition = 512, 
    RuleCursorDeclaration = 513, RuleIterateStatement = 514, RuleLeaveStatement = 515, 
    RuleGetDiagnosticsStatement = 516, RuleSignalAllowedExpr = 517, RuleStatementInformationItem = 518, 
    RuleConditionInformationItem = 519, RuleSignalInformationItemName = 520, 
    RuleSignalStatement = 521, RuleResignalStatement = 522, RuleSignalInformationItem = 523, 
    RuleCursorOpen = 524, RuleCursorClose = 525, RuleCursorFetch = 526, 
    RuleSchedule = 527, RuleColumnDefinition = 528, RuleCheckOrReferences = 529, 
    RuleCheckConstraint = 530, RuleConstraintEnforcement = 531, RuleTableConstraintDef = 532, 
    RuleConstraintName = 533, RuleFieldDefinition = 534, RuleColumnAttribute = 535, 
    RuleColumnFormat = 536, RuleStorageMedia = 537, RuleNow = 538, RuleNowOrSignedLiteral = 539, 
    RuleGcolAttribute = 540, RuleReferences = 541, RuleDeleteOption = 542, 
    RuleKeyList = 543, RuleKeyPart = 544, RuleKeyListWithExpression = 545, 
    RuleKeyPartOrExpression = 546, RuleKeyListVariants = 547, RuleIndexType = 548, 
    RuleIndexOption = 549, RuleCommonIndexOption = 550, RuleVisibility = 551, 
    RuleIndexTypeClause = 552, RuleFulltextIndexOption = 553, RuleSpatialIndexOption = 554, 
    RuleDataTypeDefinition = 555, RuleDataType = 556, RuleNchar = 557, RuleRealType = 558, 
    RuleFieldLength = 559, RuleFieldOptions = 560, RuleCharsetWithOptBinary = 561, 
    RuleAscii = 562, RuleUnicode = 563, RuleWsNumCodepoints = 564, RuleTypeDatetimePrecision = 565, 
    RuleFunctionDatetimePrecision = 566, RuleCharsetName = 567, RuleCollationName = 568, 
    RuleCreateTableOptions = 569, RuleCreateTableOptionsEtc = 570, RuleCreatePartitioningEtc = 571, 
    RuleCreateTableOptionsSpaceSeparated = 572, RuleCreateTableOption = 573, 
    RuleTernaryOption = 574, RuleDefaultCollation = 575, RuleDefaultEncryption = 576, 
    RuleDefaultCharset = 577, RulePartitionClause = 578, RulePartitionTypeDef = 579, 
    RuleSubPartitions = 580, RulePartitionKeyAlgorithm = 581, RulePartitionDefinitions = 582, 
    RulePartitionDefinition = 583, RulePartitionValuesIn = 584, RulePartitionOption = 585, 
    RuleSubpartitionDefinition = 586, RulePartitionValueItemListParen = 587, 
    RulePartitionValueItem = 588, RuleDefinerClause = 589, RuleIfExists = 590, 
    RuleIfNotExists = 591, RuleIgnoreUnknownUser = 592, RuleProcedureParameter = 593, 
    RuleFunctionParameter = 594, RuleCollate = 595, RuleTypeWithOptCollate = 596, 
    RuleSchemaIdentifierPair = 597, RuleViewRefList = 598, RuleUpdateList = 599, 
    RuleUpdateElement = 600, RuleCharsetClause = 601, RuleFieldsClause = 602, 
    RuleFieldTerm = 603, RuleLinesClause = 604, RuleLineTerm = 605, RuleUserList = 606, 
    RuleCreateUserList = 607, RuleCreateUser = 608, RuleCreateUserWithMfa = 609, 
    RuleIdentification = 610, RuleIdentifiedByPassword = 611, RuleIdentifiedByRandomPassword = 612, 
    RuleIdentifiedWithPlugin = 613, RuleIdentifiedWithPluginAsAuth = 614, 
    RuleIdentifiedWithPluginByPassword = 615, RuleIdentifiedWithPluginByRandomPassword = 616, 
    RuleInitialAuth = 617, RuleRetainCurrentPassword = 618, RuleDiscardOldPassword = 619, 
    RuleUserRegistration = 620, RuleFactor = 621, RuleReplacePassword = 622, 
    RuleUserIdentifierOrText = 623, RuleUser = 624, RuleLikeClause = 625, 
    RuleLikeOrWhere = 626, RuleOnlineOption = 627, RuleNoWriteToBinLog = 628, 
    RuleUsePartition = 629, RuleFieldIdentifier = 630, RuleColumnName = 631, 
    RuleColumnInternalRef = 632, RuleColumnInternalRefList = 633, RuleColumnRef = 634, 
    RuleInsertIdentifier = 635, RuleIndexName = 636, RuleIndexRef = 637, 
    RuleTableWild = 638, RuleSchemaName = 639, RuleSchemaRef = 640, RuleProcedureName = 641, 
    RuleProcedureRef = 642, RuleFunctionName = 643, RuleFunctionRef = 644, 
    RuleTriggerName = 645, RuleTriggerRef = 646, RuleViewName = 647, RuleViewRef = 648, 
    RuleTablespaceName = 649, RuleTablespaceRef = 650, RuleLogfileGroupName = 651, 
    RuleLogfileGroupRef = 652, RuleEventName = 653, RuleEventRef = 654, 
    RuleUdfName = 655, RuleServerName = 656, RuleServerRef = 657, RuleEngineRef = 658, 
    RuleTableName = 659, RuleFilterTableRef = 660, RuleTableRefWithWildcard = 661, 
    RuleTableRef = 662, RuleTableRefList = 663, RuleTableAliasRefList = 664, 
    RuleParameterName = 665, RuleLabelIdentifier = 666, RuleLabelRef = 667, 
    RuleRoleIdentifier = 668, RulePluginRef = 669, RuleComponentRef = 670, 
    RuleResourceGroupRef = 671, RuleWindowName = 672, RulePureIdentifier = 673, 
    RuleIdentifier = 674, RuleIdentifierList = 675, RuleIdentifierListWithParentheses = 676, 
    RuleQualifiedIdentifier = 677, RuleSimpleIdentifier = 678, RuleDotIdentifier = 679, 
    RuleUlong_number = 680, RuleReal_ulong_number = 681, RuleUlonglong_number = 682, 
    RuleReal_ulonglong_number = 683, RuleSignedLiteral = 684, RuleSignedLiteralOrNull = 685, 
    RuleLiteral = 686, RuleLiteralOrNull = 687, RuleNullAsLiteral = 688, 
    RuleStringList = 689, RuleTextStringLiteral = 690, RuleTextString = 691, 
    RuleTextStringHash = 692, RuleTextLiteral = 693, RuleTextStringNoLinebreak = 694, 
    RuleTextStringLiteralList = 695, RuleNumLiteral = 696, RuleBoolLiteral = 697, 
    RuleNullLiteral = 698, RuleInt64Literal = 699, RuleTemporalLiteral = 700, 
    RuleFloatOptions = 701, RuleStandardFloatOptions = 702, RulePrecision = 703, 
    RuleTextOrIdentifier = 704, RuleLValueIdentifier = 705, RuleRoleIdentifierOrText = 706, 
    RuleSizeNumber = 707, RuleParentheses = 708, RuleEqual = 709, RuleOptionType = 710, 
    RuleRvalueSystemVariableType = 711, RuleSetVarIdentType = 712, RuleJsonAttribute = 713, 
    RuleIdentifierKeyword = 714, RuleIdentifierKeywordsAmbiguous1RolesAndLabels = 715, 
    RuleIdentifierKeywordsAmbiguous2Labels = 716, RuleLabelKeyword = 717, 
    RuleIdentifierKeywordsAmbiguous3Roles = 718, RuleIdentifierKeywordsUnambiguous = 719, 
    RuleRoleKeyword = 720, RuleLValueKeyword = 721, RuleIdentifierKeywordsAmbiguous4SystemVariables = 722, 
    RuleRoleOrIdentifierKeyword = 723, RuleRoleOrLabelKeyword = 724
  };
