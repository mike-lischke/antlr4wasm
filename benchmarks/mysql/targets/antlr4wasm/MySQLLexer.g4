...
DOLLAR_QUOTED_STRING_TEXT: '$' DOLLAR_QUOTE_TAG_CHAR* '$' .*? '$' DOLLAR_QUOTE_TAG_CHAR* '$';
...
VERSION_COMMENT_START: ('/*!' DIGITS) (
        {this.checkMySQLVersion(this.getText())}? // Will set this.inVersionComment if the number matches.
        | .*? '*/'
    ) -> channel(HIDDEN);
