...
namespace parsers {
  ...
  public:
    ...
    virtual void enterQueryExpressionWithOptLockingClauses(
      MySQLParser::QueryExpressionWithOptLockingClausesContext *ctx) = 0;
    ...
    virtual void enterChangeReplicationSourceAutoPosition(
      MySQLParser::ChangeReplicationSourceAutoPositionContext *ctx) = 0;
    ...
    virtual void enterChangeReplicationSourceConnectRetry(
      MySQLParser::ChangeReplicationSourceConnectRetryContext *ctx) = 0;
    ...
    virtual void enterChangeReplicationSourceSSLVerifyServerCert(
      MySQLParser::ChangeReplicationSourceSSLVerifyServerCertContext *ctx) = 0;
    ...
    virtual void enterChangeReplicationSourceTLSCiphersuites(
      MySQLParser::ChangeReplicationSourceTLSCiphersuitesContext *ctx) = 0;
    ...
    virtual void enterChangeReplicationSourceZstdCompressionLevel(
      MySQLParser::ChangeReplicationSourceZstdCompressionLevelContext *ctx) = 0;
    ...
    virtual void enterAssignGtidsToAnonymousTransactionsDefinition(
      MySQLParser::AssignGtidsToAnonymousTransactionsDefinitionContext *ctx) = 0;
    ...
    virtual void enterUserAttribute(MySQLParser::UserAttributeContext *ctx) = 0;
    virtual void exitUserAttribute(MySQLParser::UserAttributeContext *ctx) = 0;
    ...
    virtual void enterStartOptionValueListFollowingOptionType(
      MySQLParser::StartOptionValueListFollowingOptionTypeContext *ctx) = 0;
    ...
    virtual void enterShowCreateProcedureStatusStatement(
      MySQLParser::ShowCreateProcedureStatusStatementContext *ctx) = 0;
    ...
    virtual void enterInExpressionUserVariableAssignment(
      MySQLParser::InExpressionUserVariableAssignmentContext *ctx) = 0;
    ...
    virtual void enterIdentifiedWithPluginByRandomPassword(
      MySQLParser::IdentifiedWithPluginByRandomPasswordContext *ctx) = 0;
    ...
    virtual void enterIdentifierKeywordsAmbiguous1RolesAndLabels(
      MySQLParser::IdentifierKeywordsAmbiguous1RolesAndLabelsContext *ctx) = 0;
    virtual void exitIdentifierKeywordsAmbiguous1RolesAndLabels(
      MySQLParser::IdentifierKeywordsAmbiguous1RolesAndLabelsContext *ctx) = 0;

    virtual void enterIdentifierKeywordsAmbiguous2Labels(
      MySQLParser::IdentifierKeywordsAmbiguous2LabelsContext *ctx) = 0;
    ...
    virtual void enterIdentifierKeywordsAmbiguous4SystemVariables(
      MySQLParser::IdentifierKeywordsAmbiguous4SystemVariablesContext *ctx) = 0;
