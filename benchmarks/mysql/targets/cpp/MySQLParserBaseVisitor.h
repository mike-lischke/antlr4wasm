...
namespace parsers {
  ...
  public:
    ...
    virtual std::any visitTransactionOrLockingStatement(
    ...
    virtual std::any visitChangeReplicationSourceSSLCLR(
    ...
    virtual std::any visitChangeReplicationSourceSSLKey(
    ...
    virtual std::any visitIdentifierListWithParentheses(
    ...
    virtual std::any visitIdentifierKeywordsUnambiguous(
