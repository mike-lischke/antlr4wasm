...
namespace parsers {
  ...
  public:
    enum {
      ...
      DECIMAL_NUMBER = 790,
      FLOAT_NUMBER = 791,
      TIMESTAMPADD_SYMBOL = 792,
      TIMESTAMPDIFF_SYMBOL = 793,
      RETURNING_SYMBOL = 794,
      JSON_VALUE_SYMBOL = 795,
      TLS_SYMBOL = 796,
      ATTRIBUTE_SYMBOL = 797,
      ENGINE_ATTRIBUTE_SYMBOL = 798,
      SECONDARY_ENGINE_ATTRIBUTE_SYMBOL = 799,
      SOURCE_CONNECTION_AUTO_FAILOVER_SYMBOL = 800,
      ZONE_SYMBOL = 801,
      GRAMMAR_SELECTOR_DERIVED_EXPR = 802,
      REPLICA_SYMBOL = 803,
      REPLICAS_SYMBOL = 804,
      ASSIGN_GTIDS_TO_ANONYMOUS_TRANSACTIONS_SYMBOL = 805,
      GET_SOURCE_PUBLIC_KEY_SYMBOL = 806,
      SOURCE_AUTO_POSITION_SYMBOL = 807,
      SOURCE_BIND_SYMBOL = 808,
      SOURCE_COMPRESSION_ALGORITHM_SYMBOL = 809,
      SOURCE_CONNECT_RETRY_SYMBOL = 810,
      SOURCE_DELAY_SYMBOL = 811,
      SOURCE_HEARTBEAT_PERIOD_SYMBOL = 812,
      SOURCE_HOST_SYMBOL = 813,
      SOURCE_LOG_FILE_SYMBOL = 814,
      SOURCE_LOG_POS_SYMBOL = 815,
      SOURCE_PASSWORD_SYMBOL = 816,
      SOURCE_PORT_SYMBOL = 817,
      SOURCE_PUBLIC_KEY_PATH_SYMBOL = 818,
      SOURCE_RETRY_COUNT_SYMBOL = 819,
      SOURCE_SSL_SYMBOL = 820,
      SOURCE_SSL_CA_SYMBOL = 821,
      SOURCE_SSL_CAPATH_SYMBOL = 822,
      SOURCE_SSL_CERT_SYMBOL = 823,
      SOURCE_SSL_CIPHER_SYMBOL = 824,
      SOURCE_SSL_CRL_SYMBOL = 825,
      SOURCE_SSL_CRLPATH_SYMBOL = 826,
      SOURCE_SSL_KEY_SYMBOL = 827,
      SOURCE_SSL_VERIFY_SERVER_CERT_SYMBOL = 828,
      SOURCE_TLS_CIPHERSUITES_SYMBOL = 829,
      SOURCE_TLS_VERSION_SYMBOL = 830,
      SOURCE_USER_SYMBOL = 831,
      SOURCE_ZSTD_COMPRESSION_LEVEL_SYMBOL = 832,
      ST_COLLECT_SYMBOL = 833,
      KEYRING_SYMBOL = 834,
      AUTHENTICATION_SYMBOL = 835,
      FACTOR_SYMBOL = 836,
      FINISH_SYMBOL = 837,
      INITIATE_SYMBOL = 838,
      REGISTRATION_SYMBOL = 839,
      UNREGISTER_SYMBOL = 840,
      INITIAL_SYMBOL = 841,
      CHALLENGE_RESPONSE_SYMBOL = 842,
      GTID_ONLY_SYMBOL = 843,
      INTERSECT_SYMBOL = 844,
      WHITESPACE = 845,
      INVALID_INPUT = 846,
      UNDERSCORE_CHARSET = 847,
      IDENTIFIER = 848,
      NCHAR_TEXT = 849,
      BACK_TICK_QUOTED_ID = 850,
      DOUBLE_QUOTED_TEXT = 851,
      SINGLE_QUOTED_TEXT = 852,
      VERSION_COMMENT_START = 853,
      MYSQL_COMMENT_START = 854,
      VERSION_COMMENT_END = 855,
      BLOCK_COMMENT = 856,
      INVALID_BLOCK_COMMENT = 857,
      POUND_COMMENT = 858,
      DASHDASH_COMMENT = 859,
      NOT_EQUAL2_OPERATOR = 860
    };

    enum {
      RuleQuery = 0,
      RuleSimpleStatement = 1,
      RuleAlterStatement = 2,
      RuleAlterDatabase = 3,
      RuleAlterDatabaseOption = 4,
      RuleAlterEvent = 5,
      RuleAlterLogfileGroup = 6,
      RuleAlterLogfileGroupOptions = 7,
      RuleAlterLogfileGroupOption = 8,
      RuleAlterServer = 9,
      RuleAlterTable = 10,
      RuleAlterTableActions = 11,
      RuleAlterCommandList = 12,
      RuleAlterCommandsModifierList = 13,
      RuleStandaloneAlterCommands = 14,
      RuleAlterPartition = 15,
      RuleAlterList = 16,
      RuleAlterCommandsModifier = 17,
      RuleAlterListItem = 18,
      RulePlace = 19,
      RuleRestrict = 20,
      RuleAlterOrderList = 21,
      RuleAlterAlgorithmOption = 22,
      RuleAlterLockOption = 23,
      RuleIndexLockAndAlgorithm = 24,
      RuleWithValidation = 25,
      RuleRemovePartitioning = 26,
      RuleAllOrPartitionNameList = 27,
      RuleAlterTablespace = 28,
      RuleAlterUndoTablespace = 29,
      RuleUndoTableSpaceOptions = 30,
      RuleUndoTableSpaceOption = 31,
      RuleAlterTablespaceOptions = 32,
      RuleAlterTablespaceOption = 33,
      RuleChangeTablespaceOption = 34,
      RuleAlterView = 35,
      RuleViewTail = 36,
      RuleViewQueryBlock = 37,
      RuleViewCheckOption = 38,
      RuleAlterInstanceStatement = 39,
      RuleCreateStatement = 40,
      RuleCreateDatabase = 41,
      RuleCreateDatabaseOption = 42,
      RuleCreateTable = 43,
      RuleTableElementList = 44,
      RuleTableElement = 45,
      RuleDuplicateAsQe = 46,
      RuleAsCreateQueryExpression = 47,
      RuleQueryExpressionOrParens = 48,
      RuleQueryExpressionWithOptLockingClauses = 49,
      RuleCreateRoutine = 50,
      RuleCreateProcedure = 51,
      RuleCreateFunction = 52,
      RuleCreateUdf = 53,
      RuleRoutineCreateOption = 54,
      RuleRoutineAlterOptions = 55,
      RuleRoutineOption = 56,
      RuleCreateIndex = 57,
      RuleIndexNameAndType = 58,
      RuleCreateIndexTarget = 59,
      RuleCreateLogfileGroup = 60,
      RuleLogfileGroupOptions = 61,
      RuleLogfileGroupOption = 62,
      RuleCreateServer = 63,
      RuleServerOptions = 64,
      RuleServerOption = 65,
      RuleCreateTablespace = 66,
      RuleCreateUndoTablespace = 67,
      RuleTsDataFileName = 68,
      RuleTsDataFile = 69,
      RuleTablespaceOptions = 70,
      RuleTablespaceOption = 71,
      RuleTsOptionInitialSize = 72,
      RuleTsOptionUndoRedoBufferSize = 73,
      RuleTsOptionAutoextendSize = 74,
      RuleTsOptionMaxSize = 75,
      RuleTsOptionExtentSize = 76,
      RuleTsOptionNodegroup = 77,
      RuleTsOptionEngine = 78,
      RuleTsOptionWait = 79,
      RuleTsOptionComment = 80,
      RuleTsOptionFileblockSize = 81,
      RuleTsOptionEncryption = 82,
      RuleTsOptionEngineAttribute = 83,
      RuleCreateView = 84,
      RuleViewReplaceOrAlgorithm = 85,
      RuleViewAlgorithm = 86,
      RuleViewSuid = 87,
      RuleCreateTrigger = 88,
      RuleTriggerFollowsPrecedesClause = 89,
      RuleCreateEvent = 90,
      RuleCreateRole = 91,
      RuleCreateSpatialReference = 92,
      RuleSrsAttribute = 93,
      RuleDropStatement = 94,
      RuleDropDatabase = 95,
      RuleDropEvent = 96,
      RuleDropFunction = 97,
      RuleDropProcedure = 98,
      RuleDropIndex = 99,
      RuleDropLogfileGroup = 100,
      RuleDropLogfileGroupOption = 101,
      RuleDropServer = 102,
      RuleDropTable = 103,
      RuleDropTableSpace = 104,
      RuleDropTrigger = 105,
      RuleDropView = 106,
      RuleDropRole = 107,
      RuleDropSpatialReference = 108,
      RuleDropUndoTablespace = 109,
      RuleRenameTableStatement = 110,
      RuleRenamePair = 111,
      RuleTruncateTableStatement = 112,
      RuleImportStatement = 113,
      RuleCallStatement = 114,
      RuleDeleteStatement = 115,
      RulePartitionDelete = 116,
      RuleDeleteStatementOption = 117,
      RuleDoStatement = 118,
      RuleHandlerStatement = 119,
      RuleHandlerReadOrScan = 120,
      RuleInsertStatement = 121,
      RuleInsertLockOption = 122,
      RuleInsertFromConstructor = 123,
      RuleFields = 124,
      RuleInsertValues = 125,
      RuleInsertQueryExpression = 126,
      RuleValueList = 127,
      RuleValues = 128,
      RuleValuesReference = 129,
      RuleInsertUpdateList = 130,
      RuleLoadStatement = 131,
      RuleDataOrXml = 132,
      RuleXmlRowsIdentifiedBy = 133,
      RuleLoadDataFileTail = 134,
      RuleLoadDataFileTargetList = 135,
      RuleFieldOrVariableList = 136,
      RuleReplaceStatement = 137,
      RuleSelectStatement = 138,
      RuleSelectStatementWithInto = 139,
      RuleQueryExpression = 140,
      RuleQueryExpressionBody = 141,
      RuleQueryExpressionParens = 142,
      RuleQueryPrimary = 143,
      RuleQuerySpecification = 144,
      RuleSubquery = 145,
      RuleQuerySpecOption = 146,
      RuleLimitClause = 147,
      RuleSimpleLimitClause = 148,
      RuleLimitOptions = 149,
      RuleLimitOption = 150,
      RuleIntoClause = 151,
      RuleProcedureAnalyseClause = 152,
      RuleHavingClause = 153,
      RuleWindowClause = 154,
      RuleWindowDefinition = 155,
      RuleWindowSpec = 156,
      RuleWindowSpecDetails = 157,
      RuleWindowFrameClause = 158,
      RuleWindowFrameUnits = 159,
      RuleWindowFrameExtent = 160,
      RuleWindowFrameStart = 161,
      RuleWindowFrameBetween = 162,
      RuleWindowFrameBound = 163,
      RuleWindowFrameExclusion = 164,
      RuleWithClause = 165,
      RuleCommonTableExpression = 166,
      RuleGroupByClause = 167,
      RuleOlapOption = 168,
      RuleOrderClause = 169,
      RuleDirection = 170,
      RuleFromClause = 171,
      RuleTableReferenceList = 172,
      RuleTableValueConstructor = 173,
      RuleExplicitTable = 174,
      RuleRowValueExplicit = 175,
      RuleSelectOption = 176,
      RuleLockingClauseList = 177,
      RuleLockingClause = 178,
      RuleLockStrengh = 179,
      RuleLockedRowAction = 180,
      RuleSelectItemList = 181,
      RuleSelectItem = 182,
      RuleSelectAlias = 183,
      RuleWhereClause = 184,
      RuleTableReference = 185,
      RuleEscapedTableReference = 186,
      RuleJoinedTable = 187,
      RuleNaturalJoinType = 188,
      RuleInnerJoinType = 189,
      RuleOuterJoinType = 190,
      RuleTableFactor = 191,
      RuleSingleTable = 192,
      RuleSingleTableParens = 193,
      RuleDerivedTable = 194,
      RuleTableReferenceListParens = 195,
      RuleTableFunction = 196,
      RuleColumnsClause = 197,
      RuleJtColumn = 198,
      RuleOnEmptyOrError = 199,
      RuleOnEmptyOrErrorJsonTable = 200,
      RuleOnEmpty = 201,
      RuleOnError = 202,
      RuleJsonOnResponse = 203,
      RuleUnionOption = 204,
      RuleTableAlias = 205,
      RuleIndexHintList = 206,
      RuleIndexHint = 207,
      RuleIndexHintType = 208,
      RuleKeyOrIndex = 209,
      RuleConstraintKeyType = 210,
      RuleIndexHintClause = 211,
      RuleIndexList = 212,
      RuleIndexListElement = 213,
      RuleUpdateStatement = 214,
      RuleTransactionOrLockingStatement = 215,
      RuleTransactionStatement = 216,
      RuleBeginWork = 217,
      RuleStartTransactionOptionList = 218,
      RuleSavepointStatement = 219,
      RuleLockStatement = 220,
      RuleLockItem = 221,
      RuleLockOption = 222,
      RuleXaStatement = 223,
      RuleXaConvert = 224,
      RuleXid = 225,
      RuleReplicationStatement = 226,
      RuleResetOption = 227,
      RuleSourceResetOptions = 228,
      RuleReplicationLoad = 229,
      RuleChangeReplicationSource = 230,
      RuleChangeSource = 231,
      RuleSourceDefinitions = 232,
      RuleSourceDefinition = 233,
      RuleChangeReplicationSourceAutoPosition = 234,
      RuleChangeReplicationSourceHost = 235,
      RuleChangeReplicationSourceBind = 236,
      RuleChangeReplicationSourceUser = 237,
      RuleChangeReplicationSourcePassword = 238,
      RuleChangeReplicationSourcePort = 239,
      RuleChangeReplicationSourceConnectRetry = 240,
      RuleChangeReplicationSourceRetryCount = 241,
      RuleChangeReplicationSourceDelay = 242,
      RuleChangeReplicationSourceSSL = 243,
      RuleChangeReplicationSourceSSLCA = 244,
      RuleChangeReplicationSourceSSLCApath = 245,
      RuleChangeReplicationSourceSSLCipher = 246,
      RuleChangeReplicationSourceSSLCLR = 247,
      RuleChangeReplicationSourceSSLCLRpath = 248,
      RuleChangeReplicationSourceSSLKey = 249,
      RuleChangeReplicationSourceSSLVerifyServerCert = 250,
      RuleChangeReplicationSourceTLSVersion = 251,
      RuleChangeReplicationSourceTLSCiphersuites = 252,
      RuleChangeReplicationSourceSSLCert = 253,
      RuleChangeReplicationSourcePublicKey = 254,
      RuleChangeReplicationSourceGetSourcePublicKey = 255,
      RuleChangeReplicationSourceHeartbeatPeriod = 256,
      RuleChangeReplicationSourceCompressionAlgorithm = 257,
      RuleChangeReplicationSourceZstdCompressionLevel = 258,
      RulePrivilegeCheckDef = 259,
      RuleTablePrimaryKeyCheckDef = 260,
      RuleAssignGtidsToAnonymousTransactionsDefinition = 261,
      RuleSourceTlsCiphersuitesDef = 262,
      RuleSourceFileDef = 263,
      RuleSourceLogFile = 264,
      RuleSourceLogPos = 265,
      RuleServerIdList = 266,
      RuleChangeReplication = 267,
      RuleFilterDefinition = 268,
      RuleFilterDbList = 269,
      RuleFilterTableList = 270,
      RuleFilterStringList = 271,
      RuleFilterWildDbTableString = 272,
      RuleFilterDbPairList = 273,
      RuleStartReplicaStatement = 274,
      RuleStopReplicaStatement = 275,
      RuleReplicaUntil = 276,
      RuleUserOption = 277,
      RulePasswordOption = 278,
      RuleDefaultAuthOption = 279,
      RulePluginDirOption = 280,
      RuleReplicaThreadOptions = 281,
      RuleReplicaThreadOption = 282,
      RuleGroupReplication = 283,
      RuleGroupReplicationStartOptions = 284,
      RuleGroupReplicationStartOption = 285,
      RuleGroupReplicationUser = 286,
      RuleGroupReplicationPassword = 287,
      RuleGroupReplicationPluginAuth = 288,
      RuleReplica = 289,
      RulePreparedStatement = 290,
      RuleExecuteStatement = 291,
      RuleExecuteVarList = 292,
      RuleCloneStatement = 293,
      RuleDataDirSSL = 294,
      RuleSsl = 295,
      RuleAccountManagementStatement = 296,
      RuleAlterUserStatement = 297,
      RuleAlterUserList = 298,
      RuleAlterUser = 299,
      RuleOldAlterUser = 300,
      RuleUserFunction = 301,
      RuleCreateUserStatement = 302,
      RuleCreateUserTail = 303,
      RuleUserAttributes = 304,
      RuleDefaultRoleClause = 305,
      RuleRequireClause = 306,
      RuleConnectOptions = 307,
      RuleAccountLockPasswordExpireOptions = 308,
      RuleUserAttribute = 309,
      RuleDropUserStatement = 310,
      RuleGrantStatement = 311,
      RuleGrantTargetList = 312,
      RuleGrantOptions = 313,
      RuleExceptRoleList = 314,
      RuleWithRoles = 315,
      RuleGrantAs = 316,
      RuleVersionedRequireClause = 317,
      RuleRenameUserStatement = 318,
      RuleRevokeStatement = 319,
      RuleAclType = 320,
      RuleRoleOrPrivilegesList = 321,
      RuleRoleOrPrivilege = 322,
      RuleGrantIdentifier = 323,
      RuleRequireList = 324,
      RuleRequireListElement = 325,
      RuleGrantOption = 326,
      RuleSetRoleStatement = 327,
      RuleRoleList = 328,
      RuleRole = 329,
      RuleTableAdministrationStatement = 330,
      RuleHistogram = 331,
      RuleCheckOption = 332,
      RuleRepairType = 333,
      RuleInstallUninstallStatement = 334,
      RuleSetStatement = 335,
      RuleStartOptionValueList = 336,
      RuleTransactionCharacteristics = 337,
      RuleTransactionAccessMode = 338,
      RuleIsolationLevel = 339,
      RuleOptionValueListContinued = 340,
      RuleOptionValueNoOptionType = 341,
      RuleOptionValue = 342,
      RuleSetSystemVariable = 343,
      RuleStartOptionValueListFollowingOptionType = 344,
      RuleOptionValueFollowingOptionType = 345,
      RuleSetExprOrDefault = 346,
      RuleShowDatabasesStatement = 347,
      RuleShowTablesStatement = 348,
      RuleShowTriggersStatement = 349,
      RuleShowEventsStatement = 350,
      RuleShowTableStatusStatement = 351,
      RuleShowOpenTablesStatement = 352,
      RuleShowPluginsStatement = 353,
      RuleShowEngineLogsStatement = 354,
      RuleShowEngineMutexStatement = 355,
      RuleShowEngineStatusStatement = 356,
      RuleShowColumnsStatement = 357,
      RuleShowBinaryLogsStatement = 358,
      RuleShowReplicasStatement = 359,
      RuleShowBinlogEventsStatement = 360,
      RuleShowRelaylogEventsStatement = 361,
      RuleShowKeysStatement = 362,
      RuleShowEnginesStatement = 363,
      RuleShowCountWarningsStatement = 364,
      RuleShowCountErrorsStatement = 365,
      RuleShowWarningsStatement = 366,
      RuleShowErrorsStatement = 367,
      RuleShowProfilesStatement = 368,
      RuleShowProfileStatement = 369,
      RuleShowStatusStatement = 370,
      RuleShowProcessListStatement = 371,
      RuleShowVariablesStatement = 372,
      RuleShowCharacterSetStatement = 373,
      RuleShowCollationStatement = 374,
      RuleShowPrivilegesStatement = 375,
      RuleShowGrantsStatement = 376,
      RuleShowCreateDatabaseStatement = 377,
      RuleShowCreateTableStatement = 378,
      RuleShowCreateViewStatement = 379,
      RuleShowMasterStatusStatement = 380,
      RuleShowReplicaStatusStatement = 381,
      RuleShowCreateProcedureStatement = 382,
      RuleShowCreateFunctionStatement = 383,
      RuleShowCreateTriggerStatement = 384,
      RuleShowCreateProcedureStatusStatement = 385,
      RuleShowCreateFunctionStatusStatement = 386,
      RuleShowCreateProcedureCodeStatement = 387,
      RuleShowCreateFunctionCodeStatement = 388,
      RuleShowCreateEventStatement = 389,
      RuleShowCreateUserStatement = 390,
      RuleShowCommandType = 391,
      RuleEngineOrAll = 392,
      RuleFromOrIn = 393,
      RuleInDb = 394,
      RuleProfileDefinitions = 395,
      RuleProfileDefinition = 396,
      RuleOtherAdministrativeStatement = 397,
      RuleKeyCacheListOrParts = 398,
      RuleKeyCacheList = 399,
      RuleAssignToKeycache = 400,
      RuleAssignToKeycachePartition = 401,
      RuleCacheKeyList = 402,
      RuleKeyUsageElement = 403,
      RuleKeyUsageList = 404,
      RuleFlushOption = 405,
      RuleLogType = 406,
      RuleFlushTables = 407,
      RuleFlushTablesOptions = 408,
      RulePreloadTail = 409,
      RulePreloadList = 410,
      RulePreloadKeys = 411,
      RuleAdminPartition = 412,
      RuleResourceGroupManagement = 413,
      RuleCreateResourceGroup = 414,
      RuleResourceGroupVcpuList = 415,
      RuleVcpuNumOrRange = 416,
      RuleResourceGroupPriority = 417,
      RuleResourceGroupEnableDisable = 418,
      RuleAlterResourceGroup = 419,
      RuleSetResourceGroup = 420,
      RuleThreadIdList = 421,
      RuleDropResourceGroup = 422,
      RuleUtilityStatement = 423,
      RuleDescribeStatement = 424,
      RuleExplainStatement = 425,
      RuleExplainableStatement = 426,
      RuleHelpCommand = 427,
      RuleUseCommand = 428,
      RuleRestartServer = 429,
      RuleExpr = 430,
      RuleBoolPri = 431,
      RuleCompOp = 432,
      RulePredicate = 433,
      RulePredicateOperations = 434,
      RuleBitExpr = 435,
      RuleSimpleExpr = 436,
      RuleArrayCast = 437,
      RuleJsonOperator = 438,
      RuleSumExpr = 439,
      RuleGroupingOperation = 440,
      RuleWindowFunctionCall = 441,
      RuleWindowingClause = 442,
      RuleLeadLagInfo = 443,
      RuleStableInteger = 444,
      RuleParamOrVar = 445,
      RuleNullTreatment = 446,
      RuleJsonFunction = 447,
      RuleInSumExpr = 448,
      RuleIdentListArg = 449,
      RuleIdentList = 450,
      RuleFulltextOptions = 451,
      RuleRuntimeFunctionCall = 452,
      RuleReturningType = 453,
      RuleGeometryFunction = 454,
      RuleTimeFunctionParameters = 455,
      RuleFractionalPrecision = 456,
      RuleWeightStringLevels = 457,
      RuleWeightStringLevelListItem = 458,
      RuleDateTimeTtype = 459,
      RuleTrimFunction = 460,
      RuleSubstringFunction = 461,
      RuleFunctionCall = 462,
      RuleUdfExprList = 463,
      RuleUdfExpr = 464,
      RuleUserVariable = 465,
      RuleInExpressionUserVariableAssignment = 466,
      RuleRvalueSystemOrUserVariable = 467,
      RuleLvalueVariable = 468,
      RuleRvalueSystemVariable = 469,
      RuleWhenExpression = 470,
      RuleThenExpression = 471,
      RuleElseExpression = 472,
      RuleCastType = 473,
      RuleExprList = 474,
      RuleCharset = 475,
      RuleNotRule = 476,
      RuleNot2Rule = 477,
      RuleInterval = 478,
      RuleIntervalTimeStamp = 479,
      RuleExprListWithParentheses = 480,
      RuleExprWithParentheses = 481,
      RuleSimpleExprWithParentheses = 482,
      RuleOrderList = 483,
      RuleOrderExpression = 484,
      RuleGroupList = 485,
      RuleGroupingExpression = 486,
      RuleChannel = 487,
      RuleCompoundStatement = 488,
      RuleReturnStatement = 489,
      RuleIfStatement = 490,
      RuleIfBody = 491,
      RuleThenStatement = 492,
      RuleCompoundStatementList = 493,
      RuleCaseStatement = 494,
      RuleElseStatement = 495,
      RuleLabeledBlock = 496,
      RuleUnlabeledBlock = 497,
      RuleLabel = 498,
      RuleBeginEndBlock = 499,
      RuleLabeledControl = 500,
      RuleUnlabeledControl = 501,
      RuleLoopBlock = 502,
      RuleWhileDoBlock = 503,
      RuleRepeatUntilBlock = 504,
      RuleSpDeclarations = 505,
      RuleSpDeclaration = 506,
      RuleVariableDeclaration = 507,
      RuleConditionDeclaration = 508,
      RuleSpCondition = 509,
      RuleSqlstate = 510,
      RuleHandlerDeclaration = 511,
      RuleHandlerCondition = 512,
      RuleCursorDeclaration = 513,
      RuleIterateStatement = 514,
      RuleLeaveStatement = 515,
      RuleGetDiagnosticsStatement = 516,
      RuleSignalAllowedExpr = 517,
      RuleStatementInformationItem = 518,
      RuleConditionInformationItem = 519,
      RuleSignalInformationItemName = 520,
      RuleSignalStatement = 521,
      RuleResignalStatement = 522,
      RuleSignalInformationItem = 523,
      RuleCursorOpen = 524,
      RuleCursorClose = 525,
      RuleCursorFetch = 526,
      RuleSchedule = 527,
      RuleColumnDefinition = 528,
      RuleCheckOrReferences = 529,
      RuleCheckConstraint = 530,
      RuleConstraintEnforcement = 531,
      RuleTableConstraintDef = 532,
      RuleConstraintName = 533,
      RuleFieldDefinition = 534,
      RuleColumnAttribute = 535,
      RuleColumnFormat = 536,
      RuleStorageMedia = 537,
      RuleNow = 538,
      RuleNowOrSignedLiteral = 539,
      RuleGcolAttribute = 540,
      RuleReferences = 541,
      RuleDeleteOption = 542,
      RuleKeyList = 543,
      RuleKeyPart = 544,
      RuleKeyListWithExpression = 545,
      RuleKeyPartOrExpression = 546,
      RuleIndexType = 547,
      RuleIndexOption = 548,
      RuleCommonIndexOption = 549,
      RuleVisibility = 550,
      RuleIndexTypeClause = 551,
      RuleFulltextIndexOption = 552,
      RuleSpatialIndexOption = 553,
      RuleDataTypeDefinition = 554,
      RuleDataType = 555,
      RuleNchar = 556,
      RuleRealType = 557,
      RuleFieldLength = 558,
      RuleFieldOptions = 559,
      RuleCharsetWithOptBinary = 560,
      RuleAscii = 561,
      RuleUnicode = 562,
      RuleWsNumCodepoints = 563,
      RuleTypeDatetimePrecision = 564,
      RuleFunctionDatetimePrecision = 565,
      RuleCharsetName = 566,
      RuleCollationName = 567,
      RuleCreateTableOptions = 568,
      RuleCreateTableOptionsEtc = 569,
      RuleCreatePartitioningEtc = 570,
      RuleCreateTableOptionsSpaceSeparated = 571,
      RuleCreateTableOption = 572,
      RuleTernaryOption = 573,
      RuleDefaultCollation = 574,
      RuleDefaultEncryption = 575,
      RuleDefaultCharset = 576,
      RulePartitionClause = 577,
      RulePartitionTypeDef = 578,
      RuleSubPartitions = 579,
      RulePartitionKeyAlgorithm = 580,
      RulePartitionDefinitions = 581,
      RulePartitionDefinition = 582,
      RulePartitionValuesIn = 583,
      RulePartitionOption = 584,
      RuleSubpartitionDefinition = 585,
      RulePartitionValueItemListParen = 586,
      RulePartitionValueItem = 587,
      RuleDefinerClause = 588,
      RuleIfExists = 589,
      RuleIfNotExists = 590,
      RuleIgnoreUnknownUser = 591,
      RuleProcedureParameter = 592,
      RuleFunctionParameter = 593,
      RuleCollate = 594,
      RuleTypeWithOptCollate = 595,
      RuleSchemaIdentifierPair = 596,
      RuleViewRefList = 597,
      RuleUpdateList = 598,
      RuleUpdateElement = 599,
      RuleCharsetClause = 600,
      RuleFieldsClause = 601,
      RuleFieldTerm = 602,
      RuleLinesClause = 603,
      RuleLineTerm = 604,
      RuleUserList = 605,
      RuleCreateUserList = 606,
      RuleCreateUser = 607,
      RuleCreateUserWithMfa = 608,
      RuleIdentification = 609,
      RuleIdentifiedByPassword = 610,
      RuleIdentifiedByRandomPassword = 611,
      RuleIdentifiedWithPlugin = 612,
      RuleIdentifiedWithPluginAsAuth = 613,
      RuleIdentifiedWithPluginByPassword = 614,
      RuleIdentifiedWithPluginByRandomPassword = 615,
      RuleInitialAuth = 616,
      RuleRetainCurrentPassword = 617,
      RuleDiscardOldPassword = 618,
      RuleUserRegistration = 619,
      RuleFactor = 620,
      RuleReplacePassword = 621,
      RuleUserIdentifierOrText = 622,
      RuleUser = 623,
      RuleLikeClause = 624,
      RuleLikeOrWhere = 625,
      RuleOnlineOption = 626,
      RuleNoWriteToBinLog = 627,
      RuleUsePartition = 628,
      RuleFieldIdentifier = 629,
      RuleColumnName = 630,
      RuleColumnInternalRef = 631,
      RuleColumnInternalRefList = 632,
      RuleColumnRef = 633,
      RuleInsertIdentifier = 634,
      RuleIndexName = 635,
      RuleIndexRef = 636,
      RuleTableWild = 637,
      RuleSchemaName = 638,
      RuleSchemaRef = 639,
      RuleProcedureName = 640,
      RuleProcedureRef = 641,
      RuleFunctionName = 642,
      RuleFunctionRef = 643,
      RuleTriggerName = 644,
      RuleTriggerRef = 645,
      RuleViewName = 646,
      RuleViewRef = 647,
      RuleTablespaceName = 648,
      RuleTablespaceRef = 649,
      RuleLogfileGroupName = 650,
      RuleLogfileGroupRef = 651,
      RuleEventName = 652,
      RuleEventRef = 653,
      RuleUdfName = 654,
      RuleServerName = 655,
      ...
      RuleEngineRef = 657,
      RuleTableName = 658,
      RuleFilterTableRef = 659,
      RuleTableRefWithWildcard = 660,
      RuleTableRef = 661,
      RuleTableRefList = 662,
      RuleTableAliasRefList = 663,
      RuleParameterName = 664,
      RuleLabelIdentifier = 665,
      RuleLabelRef = 666,
      RuleRoleIdentifier = 667,
      RulePluginRef = 668,
      RuleComponentRef = 669,
      RuleResourceGroupRef = 670,
      RuleWindowName = 671,
      RulePureIdentifier = 672,
      RuleIdentifier = 673,
      RuleIdentifierList = 674,
      RuleIdentifierListWithParentheses = 675,
      RuleQualifiedIdentifier = 676,
      RuleSimpleIdentifier = 677,
      RuleDotIdentifier = 678,
      RuleUlong_number = 679,
      RuleReal_ulong_number = 680,
      RuleUlonglong_number = 681,
      RuleReal_ulonglong_number = 682,
      RuleSignedLiteral = 683,
      RuleSignedLiteralOrNull = 684,
      RuleLiteral = 685,
      RuleLiteralOrNull = 686,
      RuleNullAsLiteral = 687,
      RuleStringList = 688,
      RuleTextStringLiteral = 689,
      RuleTextString = 690,
      RuleTextStringHash = 691,
      RuleTextLiteral = 692,
      RuleTextStringNoLinebreak = 693,
      RuleTextStringLiteralList = 694,
      RuleNumLiteral = 695,
      RuleBoolLiteral = 696,
      RuleNullLiteral = 697,
      RuleInt64Literal = 698,
      RuleTemporalLiteral = 699,
      RuleFloatOptions = 700,
      RuleStandardFloatOptions = 701,
      RulePrecision = 702,
      RuleTextOrIdentifier = 703,
      RuleLValueIdentifier = 704,
      RuleRoleIdentifierOrText = 705,
      RuleSizeNumber = 706,
      RuleParentheses = 707,
      RuleEqual = 708,
      RuleOptionType = 709,
      RuleRvalueSystemVariableType = 710,
      RuleSetVarIdentType = 711,
      RuleJsonAttribute = 712,
      RuleIdentifierKeyword = 713,
      RuleIdentifierKeywordsAmbiguous1RolesAndLabels = 714,
      RuleIdentifierKeywordsAmbiguous2Labels = 715,
      RuleLabelKeyword = 716,
      RuleIdentifierKeywordsAmbiguous3Roles = 717,
      RuleIdentifierKeywordsUnambiguous = 718,
      RuleRoleKeyword = 719,
      RuleLValueKeyword = 720,
      RuleIdentifierKeywordsAmbiguous4SystemVariables = 721,
      RuleRoleOrIdentifierKeyword = 722,
      RuleRoleOrLabelKeyword = 723
    };
    ...
    bool accountLockPasswordExpireOptionsSempred(AccountLockPasswordExpireOptionsContext *_localctx,
