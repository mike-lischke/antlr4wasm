...
import {
    FailedPredicateException, InputMismatchException, Lexer, LexerNoViableAltException, NoViableAltException, Parser,
    RecognitionException, Recognizer, Token, Vocabulary, ANTLRErrorListener
} from "antlr4ts";

import type MySQLBaseLexer from "./MySQLBaseLexer.js";
import { IntervalSet } from "antlr4ts/misc/IntervalSet.js";
...
export class MySQLErrorListener implements ANTLRErrorListener<Token> {
    ...
    public syntaxError = <T>(recognizer: Recognizer<T, any>, offendingSymbol: T | undefined,
        ...
        if (offendingSymbol) {
            ...
            if (e instanceof LexerNoViableAltException) {
                ...
                let text = lexer.getErrorDisplay(input.getText(Interval.of(lexer._tokenStartCharIndex, input.index)));
                if (text === "") {
