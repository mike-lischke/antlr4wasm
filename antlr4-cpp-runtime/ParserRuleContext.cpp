...
ParserRuleContext *ParserRuleContext::getContext(size_t ruleIndex, size_t i) const {
  if (i >= children.size()) {
    return nullptr;
  }
  ...
  for (auto *child : children) {
    if (ParserRuleContext::is(child)) {
      ParserRuleContext *typedChild = downCast<ParserRuleContext *>(child);
      if (typedChild->getRuleIndex() == ruleIndex) {
        if (j++ == i) {
          return typedChild;
        }
      }
...
std::vector<ParserRuleContext *> ParserRuleContext::getContexts(size_t ruleIndex) const {
  std::vector<ParserRuleContext *> contexts;
  for (auto *child : children) {
    if (ParserRuleContext::is(child)) {
      ParserRuleContext *typedChild = downCast<ParserRuleContext *>(child);
      if (typedChild->getRuleIndex() == ruleIndex) {
